...
export default function Banner() {
    ...
    const { data: bannersSub } = useSwr(`/api/subBanners/getAllSubBanner`, fetcher);
    var tamanho = bannersSub?.length || [];

    const deleteBanners = async (id) => {
        let data = await axios.delete(`/api/subBanners/deleteSubBanner?id=${id}`);
                                                                            ...
                                                                            <td className="text-right">
                                                                                <div className="btn-group">
                                                                                    ...
                                                                                    <button
                                                                                        ...
                                                                                        onClick={() => deleteBanners(item._id)}
                                                                                    >
                                        ...
                                        <div className="ec-cat-list card card-default mb-24px">
                                            <div className="card-body">
                                                {showEditCategoryComponent !== true ? (
                                                    ...
                                                    <EditBannerSub bannerSubEditId={bannerSubEditId} bannersSub={bannersSub} bannerImagetrue={bannerImage} setShowEditCategoryComponent={setShowEditCategoryComponent}/>
                                                )}
                                            </div>
                                        </div>
                                    </div>
