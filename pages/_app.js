...
function MyApp({ Component, pageProps }) {
  ...
  return (
    <>
      <Head>
        <meta name="description" content="As Papoulas Moda Feminina " />
        <meta name="keywords" content="As Papoulas, Moda Feminina, Moda, Roupas, Loja, Serra Negra, Vestidos, Croppeds, Calças, Camisas" />
        <meta name="author" content="Frequência (Júnior, Lucas e Victor)" />
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        <title>As Papoulas</title>
        <meta property="og:title" content="As Papoulas" />
        <meta property="og:description" content="As Papoulas - Moda Feminina - Serra Negra" />
